...
namespace Nealis\EntityRepository\Data\Type;

use DateTimeZone;
use InvalidArgumentException;

/**
 * Class DateTime for easier date handling
 * from https://github.com/briannesbitt/Carbon
 */
...
class DateTime extends \DateTime {
    ...
    /**
     * Create a DateTime instance from a string.  This is an alias for the
     ...
     * parameter of null.
     *
     * @param DateTime $testNow
     */
    public static function setTestNow(DateTime $testNow = null)
    {
    ...
    public static function hasRelativeKeywords($time)
    {
        ...
        if (preg_match('/[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}/', $time) !== 1) {
            foreach (static::$relativeKeywords as $keyword) {
                if (mb_stripos($time, $keyword) !== false) {
                    return true;
                }
            }
        }
     ...
     * @return integer
     */
    public function diffInWeeks(DateTime $dt = null, $abs = true)
    {
     ...
     * @return int
     */
    public function diffInDaysFiltered(Closure $callback, DateTime $dt = null, $abs = true)
    {
        $start = $this;
     ...
     * @return int
     */
    public function diffInWeekdays(DateTime $dt = null, $abs = true)
    {
     ...
     * @return int
     */
    public function diffInWeekendDays(DateTime $dt = null, $abs = true)
    {
        return $this->diffInDaysFiltered(function (DateTime $date) {
     ...
     * @return static
     */
    public function average(DateTime $dt = null)
    {
        $dt = ($dt === null) ? static::now($this->tz) : $dt;
     ...
     * @return boolean
     */
    public function isBirthday(DateTime $dt)
    {
